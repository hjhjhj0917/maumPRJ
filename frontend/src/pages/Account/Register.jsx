...
const Register = () => {
    ...
    const validateStep1 = () => {
        ...
        if (!formData.code.trim()) {
            ...
            isValid = false;
        } else if (parseInt(formData.code) !== flags.emailAuthNumber) {
                    ...
                    <div className="stepper-wrapper">
                        {[1, 2, 3].map((num, idx) => (
                            <React.Fragment key={num}>
                                <div
                                    className={`stepper-item ${step >= num ? (step === num ? 'active' : 'completed') : ''}`}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="action-buttons">
                            {step === 1 && (
                                <div className="btn-step-group active">
                                    <div className="btn-row right">
                                        <button type="button" className="btn-next" onClick={() => nextStep(2)}>다음
                                        </button>
                                    </div>
                                </div>
                            )}
                            {step === 2 && (
                                <div className="btn-step-group active">
                                    <div className="btn-row split">
                                        <button type="button" className="btn-prev" onClick={() => setStep(1)}>이전
                                        </button>
                                        <button type="button" className="btn-next" onClick={() => nextStep(3)}>다음
                                        </button>
                                    </div>
                                </div>
                            )}
                            {step === 3 && (
                                <div className="btn-step-group active">
                                    <div className="btn-row split">
                                        <button type="button" className="btn-prev" onClick={() => setStep(2)}>이전
                                        </button>
